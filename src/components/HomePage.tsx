...
import { getData, useLang, LanguageToggle } from "@/lib/lang";
    ...
    skills: (
      <section id="skills">
        <div className="flex min-h-0 flex-col gap-y-4">
          ...
          <div className="flex flex-col gap-5" data-testid="skills-categories">
            {DATA.skillCategories.map((category, cid) => (
              <BlurFade key={category.category} delay={BLUR_FADE_DELAY * 10 + cid * 0.05}>
              ...
              <BlurFade delay={BLUR_FADE_DELAY * 2}>
                <div className="flex flex-wrap items-center gap-3 pt-3">
                  <a
                    ...
                    className="inline-flex items-center gap-2 rounded-full bg-primary text-primary-foreground px-4 py-2 text-sm font-medium transition-opacity hover:opacity-90"
                  >
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 rounded-full border border-border bg-background px-4 py-2 text-sm font-medium transition-colors hover:bg-accent/50"
                  >
